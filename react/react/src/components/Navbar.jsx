            ...
            <div className="relative hidden md:block">
              ...
              {menu && (
                <>
                  ...
                  <div className="absolute right-0 z-20 mt-2 w-56 origin-top-right animate-fade-in rounded-xl border border-slate-200 bg-white p-1.5 shadow-lift">
        ...
        <div className="animate-fade-in border-t border-slate-200 bg-white md:hidden">
          <div className="container-app space-y-3 py-4">
            ...
            <nav className="grid gap-1">
              ...
              <NavLink to="/cart" className={navLink} onClick={() => setOpen(false)}>
                Cart ({totalItems})
              </NavLink>
              {isAuthenticated && (
                <NavLink to="/my-orders" className={navLink} onClick={() => setOpen(false)}>
                  My Orders
                </NavLink>
              )}
              {isAdmin && (
