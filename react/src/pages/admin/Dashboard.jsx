...
const STAT_STYLES = {
  revenue:  { icon: DollarSign,   color: 'text-emerald-600', bg: 'bg-emerald-50' },
  orders:   { icon: ShoppingCart, color: 'text-blue-600',    bg: 'bg-blue-50' },
  products: { icon: Package,      color: 'text-purple-600',  bg: 'bg-purple-50' },
  users:    { icon: Users,        color: 'text-amber-600',   bg: 'bg-amber-50' },
};
            ...
            <div key={key} className="card p-4 sm:p-5">
              <div className="flex items-start justify-between">
                <div className="min-w-0">
                  ...
                  <p className="mt-2 truncate text-xl font-extrabold text-slate-900 sm:text-2xl">
                    {value}
                  </p>
        ...
        <div className="card p-5 lg:col-span-2">
          <div className="mb-5 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-500">Excludes cancelled orders</p>
            </div>
            ...
            {stats.revenue_series.map((d) => {
              ...
              return (
                <div key={d.date} className="flex flex-1 flex-col items-center gap-2">
                  ...
                  <span className="text-[11px] font-medium text-slate-500">{d.date}</span>
                </div>
              );
            })}
          </div>
